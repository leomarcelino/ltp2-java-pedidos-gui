...
public class ClienteListFrame extends JInternalFrame implements ActionListener {

	private static final long serialVersionUID = -2637438284719902679L;
	
	private final String COLUMN_NAMES[] = new String[] {"ID", "Nome", "Tipo", "CNPJ/CPF"};
	private final Integer COLUMN_WIDTHS[] = new Integer[] {40, 300, 100, 150};
	...
	public ClienteListFrame(ClientePresenter presenter) {
		super("Clientes", false, true);
